package net.cloredo.blackberry.standuptimer.model;

import java.util.Date;
import java.util.List;

import net.cloredo.blackberry.standuptimer.dao.DAOFactory;
import net.cloredo.blackberry.standuptimer.dao.MeetingDAO;
